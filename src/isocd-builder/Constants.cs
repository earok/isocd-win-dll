...
namespace isocd_builder {
    public static class isocd_builder_constants {
		...
		public const string TRADEMARK_FILE_SOURCES_URL = "https://raw.githubusercontent.com/fuseoppl/isocd-win/master/src/isocd-builder/" + TRADEMARK_FILE_SOURCES_NAME;
